...
VSPD_WEBAPI_DIR="${VSPD_DIR}/webapi"
mkdir -p ${VSPD_WEBAPI_DIR}

VSPD_TEMPLATES_FROM="${HARNESS_DIR}/vspdtemplates"
VSPD_TEMPLATES_TO="${VSPD_WEBAPI_DIR}/templates"
cp -a "${VSPD_TEMPLATES_FROM}" "${VSPD_TEMPLATES_TO}"
