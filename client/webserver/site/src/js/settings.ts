...
export default class SettingsPage extends BasePage {
  ...
  forms: PageElement[]
  exchangeRateSources: PageElement[]
  ...
  constructor (body: HTMLElement) {
    ...
    this.exchangeRateSources = Doc.applySelector(page.exchangeRateSources, 'input[type=checkbox]')
    ...
    this.exchangeRateSources.forEach(src => {
      Doc.bind(src, 'change', async () => {
        const res = await postJSON('/api/ratesourcesettings', {
          disable: !src.checked,
          source: src.value
        })
