...
export default class Doc {
  ...
  /*
   * formatAssetValue formats the value in atomic units to its representation in
   * conventional units and returns the fiat value as a string.
   */
  static formatAssetValue (vAtomic: number, rate: number, unitInfo?: UnitInfo): string {
