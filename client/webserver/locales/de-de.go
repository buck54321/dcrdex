...
var DeDE = map[string]*intl.Translation{
	...
	"disable_app_pw_msg":             {T: "Gib dein App-Passwort ein um dein Konto zu deaktivieren."},
	...
	"simultaneous_servers_msg":  {T: "Der Decred DEX Client unterstützt die gleichzeitige Nutzung einer beliebigen Anzahl von DEX-Servern."},
