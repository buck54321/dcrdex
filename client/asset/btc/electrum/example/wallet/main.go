...
func run() error {
	...
	tx, err := ec.GetRawTransaction("b8f5a301aee2d7bede7cfaeac8d6e13d095b3939e011ea2d259f7ccda3083ae7")
	if err != nil {
		return err
	}
	fmt.Printf("%x\n", tx)
	...
	confs, err := ec.GetWalletTxConfs("6e1b5b3e9555507aab1ce18a6d2b327d0d6a624359543dd430eccbfefa3585dc")
	if err != nil {
		return err // if not a wallet txn: 'code 1: "Transaction not in wallet."'
	}
	fmt.Println("Confs:", confs)

	_, err = ec.GetWalletTxConfs("958e86e68a6d8c84e0fc9d1f0d7ca39cc411cf31388ef37420d048ffb99bb518")
	if err == nil {
	...
	err = ec.FreezeAddress(myAddr)
	if err != nil {
		return err
	}
	err = ec.UnfreezeAddress(myAddr)
	if err != nil {
		return err
	}
